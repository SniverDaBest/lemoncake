...
impl Display for PCIDevice {
    fn fmt(&self, f: &mut Formatter) -> fmt::Result {
        write!(
            f,
            "Bus: {} | Device: {} | Function: {} | Vendor ID: {} | Device ID: {} | Revision: {} | Programming Interface: {} | Subclass: {} | Class ID: {}",
            self.bus,
            self.device,
            self.func,
            self.vendor_id,
        ...
        for device in 0..32 {
            for function in 0..8 {
                unsafe {
                    ...
                    res.push(PCIDevice::new(
                        bus, device, function, vendor_id, device_id, rev, prog_if, subclass, class,
                    ));
                }
            }
        }
